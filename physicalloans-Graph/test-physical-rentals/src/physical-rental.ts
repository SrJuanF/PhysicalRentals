...
export function handleDebugAfterSendRequest(
  event: DebugAfterSendRequest
): void {}

export function handleDebugArgs(event: DebugArgs): void {}

export function handleDebugBeforeSendRequest(
  event: DebugBeforeSendRequest
): void {}

export function handleDebugError(event: DebugError): void {}

export function handleDebugRequestId(event: DebugRequestId): void {}

export function handleDebugToolCheck(event: DebugToolCheck): void {}
