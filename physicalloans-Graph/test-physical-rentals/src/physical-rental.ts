...
import {
  ...
  DebugAfterSendRequest as DebugAfterSendRequestEvent,
  DebugArgs as DebugArgsEvent,
  DebugBeforeSendRequest as DebugBeforeSendRequestEvent,
  DebugError as DebugErrorEvent,
  DebugRequestId as DebugRequestIdEvent,
  DebugToolCheck as DebugToolCheckEvent
...
export function handleRelistToolAvailable(
  event: RelistToolAvailableEvent): void {
...
export function handleerrorResponseRecv(event: errorResponseRecvEvent): void {
  let entity = new errorResponseRecv(event.transaction.hash.toHex())
  entity.lastError = event.params.lastError
  entity.requestId = event.params.requestId
  entity.save()
}

export function handleDebugAfterSendRequest(event: DebugAfterSendRequestEvent): void {
  let entity = new DebugAfterSendRequest(event.transaction.hash.toHex())
  entity.requestId = event.params.requestId
  entity.save()
}
export function handleDebugArgs(event: DebugArgsEvent): void {
  let entity = new DebugArgs(event.transaction.hash.toHex())
  entity.arg0 = event.params.arg0
  entity.arg1 = event.params.arg1
  entity.arg2 = event.params.arg2
  entity.save()
}
export function handleDebugBeforeSendRequest(event: DebugBeforeSendRequestEvent): void {
  let entity = new DebugBeforeSendRequest(event.transaction.hash.toHex())
  entity.msg = "Before sending request"
  entity.save()
}
export function handleDebugError(event: DebugErrorEvent): void {
  let entity = new DebugError(event.transaction.hash.toHex())
  entity.error = event.params.reason
  entity.save()
}
export function handleDebugRequestId(event: DebugRequestIdEvent): void {
  let entity = new DebugRequestId(event.transaction.hash.toHex())
  entity.requestId = event.params.requestId
  entity.save()
}
 export function handleDebugToolCheck(event: DebugToolCheckEvent): void {
  let entity = new DebugToolCheck(event.transaction.hash.toHex())
